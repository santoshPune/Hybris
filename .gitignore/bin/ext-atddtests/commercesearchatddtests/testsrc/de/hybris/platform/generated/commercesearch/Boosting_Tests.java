	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/opt/bambooagent/xml-data/build-dir/MAINTNG-TD61076-PCS/maintenance/bin/ext-atddtests/commercesearchatddtests/genresources/robottests/Boosting_Tests.txt"));
		}
