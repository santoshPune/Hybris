...
public class Cart_Promotion_Rules extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/opt/bambooagent/xml-data/build-dir/MAINTNG-TD61076-PCS/maintenance/bin/ext-atddtests/promotionengineatddtests/genresources/robottests/Cart_Promotion_Rules.txt"));
		}
	...
	@Test
	public void Test_Apply_Percentage_Threshold_Promotion_With_Excluded_Products_Udno()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Apply_Percentage_Threshold_Promotion_With_Excluded_Products_Udno";
