...
@IntegrationTest
public class Basic_Promotion_Rules extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("Basic_Promotion_Rules-log");
			robotSettings.setOutputName("Basic_Promotion_Rules-output");
			robotSettings.setReportName("Basic_Promotion_Rules-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/opt/bambooagent/xml-data/build-dir/MAINTNG-TD61076-PCS/maintenance/bin/ext-atddtests/promotionengineatddtests/genresources/robottests/Basic_Promotion_Rules.txt"));
		}
