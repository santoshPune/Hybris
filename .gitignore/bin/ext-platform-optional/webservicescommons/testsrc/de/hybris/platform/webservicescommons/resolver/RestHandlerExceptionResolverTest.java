...
public class RestHandlerExceptionResolverTest
{
	...
	@Test
	public void shouldReturnExceptionMappingFromMap()
	{
		final Map<String, Integer> statusCodeMappings = new HashMap<>();
		statusCodeMappings.put(RuntimeException.class.getSimpleName(), Integer.valueOf(123));
		resolver.setStatusCodeMappings(statusCodeMappings);
	...
	@Test
	public void shouldReturnExceptionDefaultDeprecatedAttribute()
	{
		Mockito.when(configuration.getInteger(RestHandlerExceptionResolver.DEFAULT_STATUS_PROPERTY, null))
				.thenReturn(Integer.valueOf(789));
		resolver.setDefaultStatusCode(159);
		...
		Mockito.verify(response).setStatus(159);
	}
