...
<%
	...
	final String altTxt = iconTooltip != null ? " alt=\""+HMCHelper.xssEncodeHTML(iconTooltip.replace("\"", "''"))+"\" " : "";
	final String toolTipTxt = iconTooltip != null ? " title=\""+HMCHelper.xssEncodeHTML(iconTooltip.replace("\"", "''"))+"\" " : "";
...
%>
	...
	<tr>
		<td class="smallText" style="<%= heightStyle %><%= widthStyle %>">
			<small><%= HMCHelper.xssEncodeHTML(iconLabel) %></small>
		</td>
	</tr>
</table>
