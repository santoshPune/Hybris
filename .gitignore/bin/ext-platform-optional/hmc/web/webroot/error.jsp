							...
							<tr>
								<td class="item">
									...
									<%	
											...
											out.write(HMCHelper.xssEncodeHTML( sw.getBuffer().toString() ) );
									%>
																		</pre>
									<%	
										}
										else
										{
											...
											{
												out.println( HMCHelper.xssEncodeHTML( MessageFormat.format(errormessage, new Object[] { new java.util.Date().toString() }) ) );
											}
										}
									%>
