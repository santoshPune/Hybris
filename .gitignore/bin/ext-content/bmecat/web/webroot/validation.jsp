...
<% 
	...
	try
	{
		...
		{
			out.print( "<br><font color='red'>The content to be imported has caused an error, please refer to the CronJob with code " + cronJob.getCode() +
			(cronJob.getUnresolvedDataStore() == null ?
			" (no lines were dumped) " :
			" as well as the CronJob's dump file with code " + cronJob.getUnresolvedDataStore().getCode() +  " for details.</font><br>" ));
		}
	}
