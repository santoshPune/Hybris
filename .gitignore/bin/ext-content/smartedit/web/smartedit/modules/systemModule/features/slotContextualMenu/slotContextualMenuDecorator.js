...
angular.module('slotContextualMenuDecoratorModule', ['contextualMenuServiceModule', 'contextualMenuDecoratorModule',
    ...
    .controller('slotContextualMenuController', function($controller, $scope, smarteditroot, systemEventService) {
    ...
    .directive('slotContextualMenu', function(contextualMenuService, $timeout, systemEventService) {
        return {
    ...
    .directive('basicSlotContextualMenu', function(contextualMenuService, $timeout, componentHandlerService, COMPONENT_CLASS, TYPE_ATTRIBUTE, ID_ATTRIBUTE) {
        return {
