 ...
 */
.factory('ConfigurationEditor', function($resource, hitch, copy, $q, convertToArray, $log, loadConfigManagerService, ParseError, CONFIGURATION_URI) {
 ...
 *
 */
.directive('generalConfiguration', function(modalService, $modal, $log, MODAL_BUTTON_ACTIONS, MODAL_BUTTON_STYLES, confirmationModalService) {
    return {
