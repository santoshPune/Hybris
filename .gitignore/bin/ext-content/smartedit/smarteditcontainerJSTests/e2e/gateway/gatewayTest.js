...
describe("Test gateway", function() {
    ...
    beforeEach(function() {
        browser.get('smarteditcontainerJSTests/e2e/gateway');
    });
    ...
    it("parent frame sending message is returned a failure acknowledgement and listener 1 gets a failure while listener 2 is not invoked", function() {
    ...
    xit("parent frame sending message is returned a success acknowledgement and both listeners on gateway 1 get message; listener on gateway 2 is not triggered", function() {
