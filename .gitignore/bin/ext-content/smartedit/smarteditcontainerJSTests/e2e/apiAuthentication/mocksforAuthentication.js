        ...
        $httpBackend.whenGET(/configuration/).respond(function(method, url, data, headers) {
            if (headers.Authorization === 'bearer ' + oauthToken0.access_token) {
                return [200, [{
                    ...
                    "value": "{\"smartEditLocation\":\"/smarteditcontainerJSTests/e2e/apiAuthentication/mocksforAuthentication.js\"}",
                    "key": "applications.e2eBackendMocks"
                }, {
                    "value": "{\"smartEditLocation\":\"/smarteditcontainerJSTests/e2e/apiAuthentication/dummyCmsDecorators.js\",\"authenticationMap\":{\"api1\":\"/authEntryPoint1\"}}",
                    "key": "applications.FakeModule"
                }, {
                    "value": "{\"smartEditContainerLocation\":\"/smarteditcontainerJSTests/e2e/apiAuthentication/dummyContainerModule.js\"}",
