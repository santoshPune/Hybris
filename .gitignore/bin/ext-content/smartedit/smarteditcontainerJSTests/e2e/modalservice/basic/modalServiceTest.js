 ...
 */
var clickModalCloseButton = function() {
    browser.click(by.css('#closeButton'));
};
...
assertModalWindow = function(modal_message) {
    expect(element(by.css('#modalBody')).getText()).toContain(modal_message);
};

assertFailureMessage = function(failure_message) {
...
describe("Test modal-service", function() {
    ...
    beforeEach(function() {
        browser.get('smarteditcontainerJSTests/e2e/modalservice/basic');
    });
