 ...
 */
angular.module('jsonEndpointClickAnalyticsDecoratorModule', ['ClickAnalyticsDummyDecoratorTemplatesModule', 'ClickAnalyticsDummyDecoratorMocksModule', 'restServiceFactoryModule'])
    .directive('jsonEndpointClickAnalyticsDecorator', ['restServiceFactory', function(restServiceFactory) {
        return {
            templateUrl: 'web/decorators/clickAnalytics/jsonEndpointClickAnalyticsDecoratorTemplate.html',
            restrict: 'C',
            transclude: true,
            replace: false,
            controllerAs: 'ctrl',
 ...
 */
angular.module('htmlEndpointClickAnalyticsDecoratorModule', ['ClickAnalyticsDummyDecoratorTemplatesModule', 'ClickAnalyticsDummyDecoratorMocksModule', 'restServiceFactoryModule'])
    .directive('htmlEndpointClickAnalyticsDecorator', ['restServiceFactory', function(restServiceFactory) {
        return {
            templateUrl: 'web/decorators/clickAnalytics/htmlEndpointClickAnalyticsDecoratorTemplate.html',
            restrict: 'C',
            transclude: true,
            replace: false,
            controllerAs: 'ctrl',
...
angular.module('ClickAnalyticsDummyDecoratorTemplatesModule', [])
    .run(['$templateCache', function($templateCache) {
        $templateCache.put('web/decorators/clickAnalytics/jsonEndpointClickAnalyticsDecoratorTemplate.html',
            "<div>\n" +
            "    <div class=\"row\">\n" +
        ...
        $templateCache.put('web/decorators/clickAnalytics/htmlEndpointClickAnalyticsDecoratorTemplate.html',
            "<div>\n" +
            "    <div class=\"row\">\n" +
            "        <div data-ng-transclude></div>\n" +
            "    </div>\n" +
