 ...
 */
angular.module('clientPageListAppModule', ['clientPagedListModule'])
    .controller('defaultController', function($scope) {
        ...
        this.renderers = {
            ...
            uid: function(item, key) {
                return "<span style='font-weight: bold; font-style: italic;'> {{ item[key.property] }} </span>";
            }
        };
        ...
        this.injectedContext = {
            changeColor: function(index) {
                var nth = index + 1;
                $('.paged-list-table tbody tr:nth-child(' + nth + ') .paged-list-item-name a').addClass('visited');
            }
        };
