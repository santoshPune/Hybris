...
var customMatchers = function() {
    ...
    this.addMatchers({
        ...
        toBeVisible: function() {
            return !this.actual.hasClass('ng-hide');
        },
        ...
        toBeResolvedWithDataContaining: function(expected) {
            var promiseInfo = PromiseMatcherHelper.getPromiseInfo(this.actual);
            return promiseInfo.status === PromiseMatcherHelper.states.RESOLVED && promiseInfo.data.some(function(data) {
                return angular.equals(data, expected);
            });
        }
    });
