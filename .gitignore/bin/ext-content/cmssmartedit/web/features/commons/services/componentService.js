...
angular.module('componentServiceModule', ['restServiceFactoryModule', 'functionsModule', 'resourceLocationsModule'])
     ...
     */
    .factory('ComponentService', function(restServiceFactory, hitch, $q, $log, parseQuery, TYPES_RESOURCE_URI, ITEMS_RESOURCE_URI, PAGES_CONTENT_SLOT_COMPONENT_RESOURCE_URI) {
