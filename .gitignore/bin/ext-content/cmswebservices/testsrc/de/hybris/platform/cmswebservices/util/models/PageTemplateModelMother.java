...
public class PageTemplateModelMother extends AbstractModelMother<PageTemplateModel>
{
	...
	public static final String UID_EMAIL_PAGE = "uid-email-page-template";
	...
	public static final String TEMPLATE_NAME_EMAIL_PAGE = "template-name-email-page-template";
	...
	public PageTemplateModel defaultPageTemplate(final CatalogVersionModel catalogVersion)
	{
	...
	public PageTemplateModel HomePage_Template(final CatalogVersionModel catalogVersion)
	{
	...
	public PageTemplateModel EmailPage_Template(final CatalogVersionModel catalogVersion)
	{
		final MediaModel previewIcon = mediaModelMother.createLogoMediaModelWithCode(catalogVersion, MEDIA_DESKTOP);
		return getOrSaveAndReturn( //
				() -> pageTemplateDao.getByUidAndCatalogVersion(UID_EMAIL_PAGE, catalogVersion), //
				() -> PageTemplateModelBuilder.fromModel(defaultPageTemplate(catalogVersion)) //
				.withUid(UID_EMAIL_PAGE) //
				.withFrontendTemplateName(TEMPLATE_NAME_EMAIL_PAGE) //
				.withPreviewIcon(previewIcon)
				.withRestrictedPageTypes( //
						cmsPageTypeModelMother.ContentPage(), //
						cmsPageTypeModelMother.CatalogPage()) //
	...
	public PageTemplateModel SearchPage_Template(final CatalogVersionModel catalogVersion)
	{
		final MediaModel previewIcon = mediaModelMother.createLogoMediaModelWithCode(catalogVersion, MEDIA_DESKTOP);
		return getOrSaveAndReturn( //
