...
import de.hybris.platform.cmswebservices.media.facade.populator.BasicNamedQueryDataPopulator;
...
public class BasicNamedQueryDataPopulatorTest
{
	...
	private static final String SORT = //
			SORT_LIST.get(0).getParameter() + ":" + SORT_LIST.get(0).getDirection().name() + "," + SORT_LIST.get(1)
					.getParameter() + ":" + SORT_LIST.get(1).getDirection().name();

	private static final String BAD_CURRENT_PAGE = "1";
	private static final String BAD_PAGE_SIZE = "100";
	...
	{
		BasicNamedQueryDataPopulator basicNamedQueryDataPopulator = new BasicNamedQueryDataPopulator();
