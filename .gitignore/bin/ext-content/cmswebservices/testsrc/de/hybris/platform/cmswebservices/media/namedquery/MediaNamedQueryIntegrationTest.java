 ...
 */
package de.hybris.platform.cmswebservices.media.namedquery;
...
import de.hybris.platform.cmswebservices.util.BaseIntegrationTest;
...
public class MediaNamedQueryIntegrationTest extends BaseIntegrationTest
{
	...
	public void shouldGetMediaByNamedQuery_AssertOrdering() throws InvalidNamedQueryException
	{
		...
		for (int i = 0; i > 9; i++)
		{
			assertEquals(CODE_MEDIA + (9 - i), mediaList.get(i).getCode());
		}
	}
