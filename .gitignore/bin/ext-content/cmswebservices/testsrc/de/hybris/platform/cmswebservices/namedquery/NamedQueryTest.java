...
public class NamedQueryTest
{
	...
	private static final List<Sort> SORT_PARAMS = Arrays.asList(new Sort().withDirection(SortDirection.ASC).withParameter(
					"param1"), new Sort().withDirection(SortDirection.ASC).withParameter("param2"));
