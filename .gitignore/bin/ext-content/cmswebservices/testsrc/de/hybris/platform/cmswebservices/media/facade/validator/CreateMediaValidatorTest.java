 ...
 */
package de.hybris.platform.cmswebservices.media.facade.validator;
...
public class CreateMediaValidatorTest
{
	...
	public void shouldFailCodeNotUnique()
	{
		...
		assertFieldError(CmswebservicesConstants.FIELD_ALREADY_EXIST, CreateMediaValidator.CODE);
	}
	...
	public void shouldFailCodeTooLongAndNotUnique()
	{
		...
		assertTrue(errors.hasErrors());
		assertEquals(1, errors.getFieldErrorCount());
		assertFieldError(CmswebservicesConstants.FIELD_LENGTH_EXCEEDED, CreateMediaValidator.CODE);
	}
	...
	public void shouldFailDescriptionTooLong()
	{
		...
		assertTrue(errors.hasErrors());
		assertEquals(1, errors.getFieldErrorCount());
		assertFieldError(CmswebservicesConstants.FIELD_LENGTH_EXCEEDED, CreateMediaValidator.DESCRIPTION);
	}
	...
	public void shouldFailNullCode()
	{
		...
		assertTrue(errors.hasErrors());
		assertEquals(1, errors.getFieldErrorCount());
		assertFieldError(CmswebservicesConstants.FIELD_REQUIRED, CreateMediaValidator.CODE);
	}
	...
	public void shouldFailAllNullFieldsValidations()
	{
		...
		assertFieldError(CmswebservicesConstants.FIELD_REQUIRED, CreateMediaValidator.CODE);
		assertFieldError(CmswebservicesConstants.FIELD_REQUIRED, CreateMediaValidator.DESCRIPTION);
		assertFieldError(CmswebservicesConstants.FIELD_REQUIRED, CreateMediaValidator.ALT_TEXT);
	}
