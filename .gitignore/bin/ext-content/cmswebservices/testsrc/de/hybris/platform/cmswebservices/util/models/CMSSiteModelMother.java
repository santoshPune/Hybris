...
public class CMSSiteModelMother extends AbstractModelMother<CMSSiteModel> {
	...
	public enum TemplateSite {
		APPAREL(buildName(Locale.ENGLISH, "Apparel"), SiteModelMother.APPAREL, "http://apparel.com", "&attachment=true"), //
		POWER_TOOLS(buildName(Locale.ENGLISH, "Power Tools"), SiteModelMother.POWERTOOL, "http://power.com", "&attachment=true"), //
	...
	protected CMSSiteModel createSiteWithMinimumParameters(final String name, final String uid, final String url, final CatalogVersionModel[] catalogs) {
		...
		final List<ContentCatalogModel> contentCatalogs = asList(catalogs)
