...
import de.hybris.platform.cmswebservices.media.service.CMSMediaFormatService;
...
public class MediaContainerDataPopulatorTest
{
	...
	@InjectMocks
	private MediaContainerDataPopulator populator;
	...
	private  Map<String, String> getLocalizedMultiValueMap()
	{
	...
	private MediaModel createMedia(final String mediaCode)
	{
