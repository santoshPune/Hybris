...
import de.hybris.platform.cmswebservices.dto.MediaFileDto;
...
public class CreateMediaFileValidatorTest
{
	...
	public void shouldFailFileClosed() throws IOException
	{
		...
		assertFieldError(CmswebservicesConstants.MEDIA_INPUT_STREAM_CLOSED, CreateMediaFileValidator.INPUT_STREAM);
	}
	...
	public void shouldFailFileNull()
	{
		...
		assertTrue(errors.hasErrors());
		assertEquals(1, errors.getFieldErrorCount());
		assertFieldError(CmswebservicesConstants.FIELD_REQUIRED, CreateMediaFileValidator.INPUT_STREAM);
	}
	...
	public void shouldFailAllValidations()
	{
		...
		assertFieldError(CmswebservicesConstants.FIELD_REQUIRED, CreateMediaFileValidator.INPUT_STREAM);
		assertFieldError(CmswebservicesConstants.FIELD_FORMAT_INVALID, CreateMediaFileValidator.MIME);
	}
