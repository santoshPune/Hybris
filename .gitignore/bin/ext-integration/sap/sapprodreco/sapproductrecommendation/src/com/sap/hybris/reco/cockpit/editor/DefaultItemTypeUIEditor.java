...
public class DefaultItemTypeUIEditor extends AbstractTextBasedUIEditor
{
	...
	{
		final int index = getPosition(value) - 1;
		if (index >= 0)
		{
	...
	protected void fillComboBox()
	{
		...
		comboitem.setLabel(
				de.hybris.platform.util.localization.Localization.getLocalizedString("type.CMSSAPRecommendationComponent.product"));
		...
		comboitem.setLabel(
				de.hybris.platform.util.localization.Localization.getLocalizedString("type.CMSSAPRecommendationComponent.category"));
