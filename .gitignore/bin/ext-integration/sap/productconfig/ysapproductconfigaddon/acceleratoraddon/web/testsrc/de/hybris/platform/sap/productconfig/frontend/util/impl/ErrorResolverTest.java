...
public class ErrorResolverTest
{
	...
	public void setup()
	{
		...
		errors = new BeanPropertyBindingResult(configData, SapproductconfigaddonConstants.CONFIG_ATTRIBUTE);
		...
		ObjectError validationError = new FieldError(SapproductconfigaddonConstants.CONFIG_ATTRIBUTE, getPath(0, 0),
		...
		errors.addError(conflictError);
		validationError = new FieldError(SapproductconfigaddonConstants.CONFIG_ATTRIBUTE, getPath(0, 1), VALIDATION_ERROR_MESSAGE);
		errors.addError(validationError);
		...
		errors.addError(conflictError);
		validationError = new FieldError(SapproductconfigaddonConstants.CONFIG_ATTRIBUTE, getPath(1, 0), VALIDATION_ERROR_MESSAGE);
		errors.addError(validationError);
		...
		mandatoryFieldError = new MandatoryFieldError(configData.getGroups().get(0).getSubGroups().get(0).getCstics().get(0),
				...
				{ "", "" }, MAND_FIELD_ERROR_MESSAGE);
		errors.addError(mandatoryFieldError);
		validationError = new FieldError(SapproductconfigaddonConstants.CONFIG_ATTRIBUTE, "groups[0].subGroups[0].cstics[0]",
				VALIDATION_ERROR_MESSAGE);
		errors.addError(validationError);
		...
		final Object[] args =
		{ "arg0", "arg1", "arg2" };
		final ObjectError validationErrorWithArg = new FieldError(SapproductconfigaddonConstants.CONFIG_ATTRIBUTE, getPath(0, 2),
