...
public class SolvableConflictPopulatorTest
{
	...
	public void testCreateConflictHeaderUiGroup()
	{
		...
		final ArrayList<UiGroupData> headerUiGroups = classUnderTest.createConflictHeader(conflictGroups);
	...
	public void testCreateConflictListCsticNotAvailable()
	{
		...
		//Thus we expect an exception, as sorting is not possible
		solvableConflicts.add(solvableConflict3);
		solvableConflicts.add(solvableConflict3);
		classUnderTest.createConflictList(configurationData, solvableConflicts);
	}
