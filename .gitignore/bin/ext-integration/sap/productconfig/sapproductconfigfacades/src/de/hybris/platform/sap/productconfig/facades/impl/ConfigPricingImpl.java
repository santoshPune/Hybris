...
public class ConfigPricingImpl implements ConfigPricing
{
	...
	public PriceData getPriceData(final PriceModel priceModel)
	{
		...
		if (priceModel == null || hasNoPrice(priceModel) || hasNoCurrency(priceModel.getCurrency()))
		{
	...
	protected boolean hasNoPrice(final PriceModel priceModel)
	{
		return priceModel == PriceModel.NO_PRICE || priceModel.getPriceValue() == null;
	}
