 ...
 */
package de.hybris.platform.sap.sapymktsync.jalo;
...
/**
 * This is the extension manager of the Sapymktsync extension.
 */
public class SapymktsyncManager extends GeneratedSapymktsyncManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapymktsyncManager.class.getName());
	 ...
	 */
	public static SapymktsyncManager getInstance()
	{
		return (SapymktsyncManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapymktsyncConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapymktsyncManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapymktsyncManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapymktsyncManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapymktsyncManager called, current tenant: " + getTenant().getTenantID());
		}
	}
