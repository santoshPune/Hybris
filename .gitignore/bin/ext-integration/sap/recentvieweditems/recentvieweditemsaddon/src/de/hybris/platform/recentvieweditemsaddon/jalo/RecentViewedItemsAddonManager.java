 ...
 *
 */
package de.hybris.platform.recentvieweditemsaddon.jalo;

import de.hybris.platform.core.Registry;
import de.hybris.platform.recentvieweditemsaddon.constants.RecentViewedItemsAddonConstants;
...
public class RecentViewedItemsAddonManager extends GeneratedRecentViewedItemsAddonManager
{
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of RecentvieweditemsaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of RecentvieweditemsaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
