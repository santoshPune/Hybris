 ...
 */
package de.hybris.platform.sap.saporderexchangehmc.jalo;
...
import de.hybris.platform.sap.saporderexchangehmc.constants.SaporderexchangehmcConstants;



/**
 * This is the extension manager of the Saporderexchangehmc extension.
 */
public class SaporderexchangehmcManager extends GeneratedSaporderexchangehmcManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SaporderexchangehmcManager.class.getName());
	 ...
	 */
	public static SaporderexchangehmcManager getInstance()
	{
		return (SaporderexchangehmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SaporderexchangehmcConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SaporderexchangehmcManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SaporderexchangehmcManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SaporderexchangehmcManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SaporderexchangehmcManager called, current tenant: " + getTenant().getTenantID());
		}
	}
