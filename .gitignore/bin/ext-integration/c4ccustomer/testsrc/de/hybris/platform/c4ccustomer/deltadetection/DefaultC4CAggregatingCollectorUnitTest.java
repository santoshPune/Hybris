...
public class DefaultC4CAggregatingCollectorUnitTest extends ServicelayerTest
{
	...
	private BatchingCollector customersCollector;
	private BatchingCollector addressesCollector;
	...
	public void setUp()
	{
		...
		customersCollector = mock(BatchingCollector.class);
		addressesCollector = mock(BatchingCollector.class);
