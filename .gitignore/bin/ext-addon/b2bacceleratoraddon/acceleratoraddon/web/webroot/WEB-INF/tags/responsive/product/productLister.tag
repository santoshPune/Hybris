...
<ul id="resultsList" class="item-list"
    ...
    <li class="hidden-xs hidden-sm">
        <ul class="item-list-header">
            ...
            <li class="item-description"><spring:theme code="basket.page.productdetails"/></li>
            <li class="item-variants"><spring:theme code="basket.page.id"/></li>
