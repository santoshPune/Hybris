...
/**
 * This is the extension manager of the Verticalnavigationaddon extension.
 */
public class VerticalnavigationaddonManager extends GeneratedVerticalnavigationaddonManager
{
	 ...
	 */
	public static VerticalnavigationaddonManager getInstance()
	{
		return (VerticalnavigationaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				VerticalnavigationaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public VerticalnavigationaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of VerticalnavigationaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of VerticalnavigationaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of VerticalnavigationaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
