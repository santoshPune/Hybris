...
/**
 * This is the extension manager of the Chineselogisticaddon extension.
 */
public class ChineselogisticaddonManager extends GeneratedChineselogisticaddonManager
{
	 ...
	 */
	public static ChineselogisticaddonManager getInstance()
	{
		return (ChineselogisticaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ChineselogisticaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ChineselogisticaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ChineselogisticaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ChineselogisticaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ChineselogisticaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
