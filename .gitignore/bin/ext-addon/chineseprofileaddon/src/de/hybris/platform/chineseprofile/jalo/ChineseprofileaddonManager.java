...
/**
 * This is the extension manager of the Chineseprofileaddon extension.
 */
public class ChineseprofileaddonManager extends GeneratedChineseprofileaddonManager
{
	 ...
	 */
	public static ChineseprofileaddonManager getInstance()
	{
		return (ChineseprofileaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ChineseprofileaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ChineseprofileaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ChineseprofileaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ChineseprofileaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ChineseprofileaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
