...
/**
 * This is the extension manager of the Chinesepspwechatpaymentaddon extension.
 */
public class ChinesepspwechatpaymentaddonManager extends GeneratedChinesepspwechatpaymentaddonManager
{
	 ...
	 */
	public static ChinesepspwechatpaymentaddonManager getInstance()
	{
		return (ChinesepspwechatpaymentaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ChinesepspwechatpaymentaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ChinesepspwechatpaymentaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ChinesepspwechatpaymentaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ChinesepspwechatpaymentaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ChinesepspwechatpaymentaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
