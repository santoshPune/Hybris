...
/**
 * This is the extension manager of the Chinesepaymentaddon extension.
 */
public class ChinesepaymentaddonManager extends GeneratedChinesepaymentaddonManager
{
	 ...
	 */
	public static ChinesepaymentaddonManager getInstance()
	{
		return (ChinesepaymentaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ChinesepaymentaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ChinesepaymentaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ChinesepaymentaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ChinesepaymentaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ChinesepaymentaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
