...
/**
 * This is the extension manager of the Chineseaddressaddon extension.
 */
public class ChineseaddressaddonManager extends GeneratedChineseaddressaddonManager
{
	 ...
	 */
	public static ChineseaddressaddonManager getInstance()
	{
		return (ChineseaddressaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ChineseaddressaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ChineseaddressaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ChineseaddressaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ChineseaddressaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ChineseaddressaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
