...
/**
 * This is the extension manager of the Chinesetaxinvoiceaddon extension.
 */
public class ChinesetaxinvoiceaddonManager extends GeneratedChinesetaxinvoiceaddonManager
{
	 ...
	 */
	public static ChinesetaxinvoiceaddonManager getInstance()
	{
		return (ChinesetaxinvoiceaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ChinesetaxinvoiceaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ChinesetaxinvoiceaddonManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ChinesetaxinvoiceaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ChinesetaxinvoiceaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ChinesetaxinvoiceaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
