...
<div class="js-quick-order-container" data-quick-order-min-rows="${quickOrderMinRows}"
	...
	<ul class="item-list cart__list quick-order__list js-ul-container">
		<li class="hidden-xs hidden-sm">
			<ul class="item-list-header">
				<li class="item-sku-input"><spring:theme code="text.quickOrder.page.product"/></li>
				<li class="item-image"></li>
				<li class="item-info"></li>
				<li class="item-price"><spring:theme code="text.quickOrder.page.price"/></li>
				<li class="item-quantity"><spring:theme code="text.quickOrder.page.qty"/></li>
				<li class="item-total-column"><spring:theme code="text.quickOrder.page.total"/></li>
				<li class="item-remove"></li>
			</ul>
		</li>

        <c:forEach begin="1" end="${quickOrderMinRows}">
            <li class="item-list-item js-li-container">
                <div class="item-sku-input js-sku-container">
...
<script id="quickOrderRowTemplate" type="text/x-jquery-tmpl">
	...
	<div class="item-image js-product-info">
	...
	<div class="item-info js-product-info">
		<a href="${request.contextPath}{{= url}}" tabindex="-1">
	...
	<div class="item-price js-product-price js-product-info" data-product-price="{{= price.value}}">
	...
	<div class="item-quantity js-product-info">
	...
	<div class="item-total js-product-info js-quick-order-item-total">
		{{if stock.stockLevelStatus.code && stock.stockLevelStatus.code != 'outOfStock'}}
			{{= price.formattedValue}}
		{{/if}}
	</div>
