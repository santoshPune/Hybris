...
module.exports = function(config) {
    config.set({
        ...
        junitReporter: {
            outputDir: 'jsTarget/test/ysmarteditmodule/junit/', // results will be saved as $outputDir/$browserName.xml
        ...
        files: [
            ...
            'buildArtifacts/seLibraries/smartEdit/services/functions.js',
            'buildArtifacts/seLibraries/smartEdit/services/restServiceFactory.js',
            'buildArtifacts/seLibraries/smartEdit/services/i18nInterceptor.js',
            'buildArtifacts/seLibraries/smartEdit/services/translateService.js',

            'jsTests/utils/**/*.js',
            'web/**/*.html',
            'web/features/commons/**/*.js',
            'jsTarget/web/features/ysmarteditmodule/templates.js',
            'web/features/ysmarteditmodule/**/*.js',
            'jsTests/ysmarteditmodule/unit/features/**/*.js'
        ],
