...
module.exports = function(config) {
    config.set({
        ...
        junitReporter: {
            outputDir: 'jsTarget/test/ysmarteditmoduleContainer/junit/', // results will be saved as $outputDir/$browserName.xml
        ...
        files: [
            ...
            'buildArtifacts/seLibraries/smartEditContainer/services/functions.js',
            'buildArtifacts/seLibraries/smartEditContainer/services/restServiceFactory.js',
            'buildArtifacts/seLibraries/smartEditContainer/services/loadConfigurationsService.js',
            'buildArtifacts/seLibraries/smartEditContainer/services/i18nInterceptor.js',
            'buildArtifacts/seLibraries/smartEditContainer/services/translateService.js',

            'jsTests/utils/**/*.js',
            'web/**/*.html',
            'web/features/commons/**/*.js',
            'jsTarget/web/features/ysmarteditmoduleContainer/templates.js',
            'web/features/ysmarteditmoduleContainer/**/*.js',
            'jsTests/ysmarteditmoduleContainer/unit/features/**/*.js'
        ],
