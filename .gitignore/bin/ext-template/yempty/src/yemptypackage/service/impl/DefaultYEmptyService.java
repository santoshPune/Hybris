...
public class DefaultYEmptyService implements YEmptyService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultYEmptyService.class);
	...
	{
		return DefaultYEmptyService.class.getResourceAsStream("/yempty/sap-hybris-platform.png");
	}
