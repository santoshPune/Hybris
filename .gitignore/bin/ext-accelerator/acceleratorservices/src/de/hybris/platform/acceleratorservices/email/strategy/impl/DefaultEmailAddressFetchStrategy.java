...
public class DefaultEmailAddressFetchStrategy implements EmailAddressFetchStrategy
{
	...
	{
		return getModelService().isUniqueConstraintErrorAsRooCause(exception)
			...
			final String displayName)
	{
		...
		// UPDATE: This is no longer just a Hana hack, it appears to apply to MySQL and possibly others as well.
		// In fact, it becomes mandatory when enabling Service Layer Direct by setting persistence.legacy.mode=false
