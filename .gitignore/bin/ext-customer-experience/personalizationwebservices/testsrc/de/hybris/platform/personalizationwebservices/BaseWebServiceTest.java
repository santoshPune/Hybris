...
public class BaseWebServiceTest extends ServicelayerTest
{
	...
	protected static final String CMSMANAGER_USERNAME = "cmsmanager";
	...
	public void assertDateTimeAlmostEqual(Date expected, Date actual)
	{
		assertDateTimeAlmostEqual(null, expected, actual);
	}

	public void assertDateTimeAlmostEqual(String message, Date expected, Date actual)
	{
		SimpleDateFormat f = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ssZ");
		String e = f.format(expected);
		String a = f.format(actual);
