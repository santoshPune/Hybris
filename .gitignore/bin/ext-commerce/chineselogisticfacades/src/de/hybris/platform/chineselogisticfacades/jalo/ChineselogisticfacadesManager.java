...
/**
 * This is the extension manager of the Chineselogisticfacades extension.
 */
public class ChineselogisticfacadesManager extends GeneratedChineselogisticfacadesManager
{
	 ...
	 */
	public static ChineselogisticfacadesManager getInstance()
	{
		return (ChineselogisticfacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ChineselogisticfacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ChineselogisticfacadesManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ChineselogisticfacadesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ChineselogisticfacadesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ChineselogisticfacadesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
