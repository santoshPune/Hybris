...
/**
 * This is the extension manager of the Chinesetaxinvoicefacades extension.
 */
public class ChinesetaxinvoicefacadesManager extends GeneratedChinesetaxinvoicefacadesManager
{
	 ...
	 */
	public static ChinesetaxinvoicefacadesManager getInstance()
	{
		return (ChinesetaxinvoicefacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ChinesetaxinvoicefacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ChinesetaxinvoicefacadesManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ChinesetaxinvoicefacadesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ChinesetaxinvoicefacadesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ChinesetaxinvoicefacadesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
