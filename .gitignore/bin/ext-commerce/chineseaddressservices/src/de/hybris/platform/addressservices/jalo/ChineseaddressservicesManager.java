...
/**
 * This is the extension manager of the Chineseaddressservices extension.
 */
public class ChineseaddressservicesManager extends GeneratedChineseaddressservicesManager
{
	 ...
	 */
	public static ChineseaddressservicesManager getInstance()
	{
		return (ChineseaddressservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ChineseaddressservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ChineseaddressservicesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ChineseaddressservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ChineseaddressservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ChineseaddressservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
