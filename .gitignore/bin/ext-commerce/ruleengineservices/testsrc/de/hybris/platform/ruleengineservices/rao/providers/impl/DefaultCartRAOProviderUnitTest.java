...
public class DefaultCartRAOProviderUnitTest
{
	...
	public void setUp() throws Exception
	{
		...
		final AbstractPopulatingConverter<CartModel, CartRAO> cartRaoConverter = new AbstractPopulatingConverter<>();
	...
	public void testExpandFactModelExpandUsersWithGroups()
	{
		...
		Mockito.when(userService.getAllUserGroupsForUser(cartContext.getCartModel().getUser()))
				.thenReturn(ImmutableSet.of(userGroupModel));
	...
	private <SOURCE, TARGET> AbstractPopulatingConverter<SOURCE, TARGET> createNewConverter(final Class<TARGET> targetClass,
