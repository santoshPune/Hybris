...
public class UnifiedOrderRequestProcessorTest
{
	...
	public void prepare()
	{
		...
		processor = new UnifiedOrderRequestProcessor(config, httpClient, openId, order, clientIp);
	}
	...
	public void test_Init()
	{
		...
		assertEquals("1", parameters.get("total_fee"));
		assertEquals("https://abc129.cn/yacceleratorstorefront" + WechatPaymentConstants.Controller.NOTIFY_URL,
