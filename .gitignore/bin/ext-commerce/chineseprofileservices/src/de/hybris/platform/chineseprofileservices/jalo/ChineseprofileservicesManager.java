...
/**
 * This is the extension manager of the Chineseprofileservices extension.
 */
public class ChineseprofileservicesManager extends GeneratedChineseprofileservicesManager
{
	 ...
	 */
	public static ChineseprofileservicesManager getInstance()
	{
		return (ChineseprofileservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(ChineseprofileservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ChineseprofileservicesManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ChineseprofileservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ChineseprofileservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ChineseprofileservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
