...
public class DefaultFitnessServiceTest
{
	...
	public void setUp()
	{
		...
		Mockito.when(orderModel.getStore()).thenReturn(baseStore);
		...
		Mockito.when(sourcingFactorService.getAllSourcingFactorsForBaseStore(baseStore)).thenReturn(factors);
