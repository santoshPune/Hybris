...
public class DefaultCouponFacadeTest
{
	...
	@Mock
	private AbstractPopulatingConverter<CouponCodeDetails, VoucherData> couponCodeDetailsConverter;
	...
	public void setUp()
	{
		...
		couponCodeDetails = new CouponCodeDetails();
		...
		when(couponCodeDetailsConverter.convert(couponCodeDetails)).thenReturn(voucherData);
	...
	public void testGetCouponDetails() throws VoucherOperationException
	{
		...
		verify(couponService).getCouponDetails(COUPON_CODE);
