...
public class DefaultOrgUnitServiceIntegrationTest extends BaseCommerceBaseTest
{
	...
	protected void validateCreateUnit()
	{
		...
		defaultOrgUnitService.createUnit(createOrgUnitParam(null, rootUnit, EU_UNIT_UID, EU_UNIT_NAME, Boolean.TRUE,
				EU_UNIT_DESCRIPTION));
	...
	public void shouldNotCreateUnitForOrgManager()
	{
		...
		defaultOrgUnitService.createUnit(createOrgUnitParam(null, getUnit(ROOT_UNIT_UID), EU_UNIT_UID, EU_UNIT_NAME, Boolean.TRUE,
				EU_UNIT_DESCRIPTION));
	}
	...
	{
		defaultOrgUnitService.createUnit(createOrgUnitParam(null, getUnit(ROOT_UNIT_UID), null, EU_UNIT_NAME, Boolean.TRUE,
				EU_UNIT_DESCRIPTION));
	}
	...
	{
		defaultOrgUnitService.createUnit(createOrgUnitParam(null, getUnit(ROOT_UNIT_UID), EU_UNIT_UID, null, Boolean.TRUE,
				EU_UNIT_DESCRIPTION));
	}
	...
	{
		defaultOrgUnitService.createUnit(createOrgUnitParam(null, getUnit(ROOT_UNIT_UID), EU_UNIT_UID, EU_UNIT_NAME, null,
				EU_UNIT_DESCRIPTION));
	}
	...
	public void shouldUpdateUnit()
	{
		...
		defaultOrgUnitService.updateUnit(createOrgUnitParam(montreal, canada, UPDATED_UNIT_UID, UPDATED_UNIT_NAME, Boolean.FALSE,
	...
	public void shouldNotUpdateUnitForOrgEmployee()
	{
		...
		defaultOrgUnitService.updateUnit(createOrgUnitParam(montreal, null, UPDATED_UNIT_UID, UPDATED_UNIT_NAME, Boolean.FALSE,
				UPDATED_UNIT_DESCRIPTION));
	}
	...
	protected void validateAddMembers()
	{
		...
		defaultOrgUnitService.addMembers(createOrgUnitMemberParameter(NA_UNIT_UID, employees, EmployeeModel.class,
	...
	public void shouldNotAddMembersForOrgEmployee()
	{
		...
		defaultOrgUnitService.addMembers(createOrgUnitMemberParameter(CA_UNIT_UID, Collections.emptySet(), EmployeeModel.class,
				createPageableData(0, 5)));
	}
	...
	{
		defaultOrgUnitService.addMembers(createOrgUnitMemberParameter(null, Collections.emptySet(), EmployeeModel.class,
				createPageableData(0, 5)));
	}
	...
	{
		defaultOrgUnitService.addMembers(createOrgUnitMemberParameter(NA_UNIT_UID, null, EmployeeModel.class,
				createPageableData(0, 5)));
	}
	...
	protected void validateRemoveMembers()
	{
		...
		defaultOrgUnitService.removeMembers(createOrgUnitMemberParameter(US_UNIT_UID, employees, EmployeeModel.class,
				createPageableData(0, 5)));
	...
	public void shouldNotRemoveMembersForOrgEmployee()
	{
		...
		defaultOrgUnitService.removeMembers(createOrgUnitMemberParameter(US_UNIT_UID, Collections.emptySet(), EmployeeModel.class,
				createPageableData(0, 5)));
	}
	...
	{
		defaultOrgUnitService.removeMembers(createOrgUnitMemberParameter(null, Collections.emptySet(), EmployeeModel.class,
				createPageableData(0, 5)));
	}
	...
	{
		defaultOrgUnitService.removeMembers(createOrgUnitMemberParameter(NA_UNIT_UID, null, EmployeeModel.class,
				createPageableData(0, 5)));
	}
	...
	{
		final SearchPageData<EmployeeModel> searchPageData = defaultOrgUnitService.getMembers(createOrgUnitMemberParameter(
				NA_UNIT_UID, Collections.emptySet(), EmployeeModel.class, createPageableData(0, 5)));
	...
	public void shouldNotGetMembersForNonOrgEmployee()
	{
		...
		defaultOrgUnitService.getMembers(createOrgUnitMemberParameter(NA_UNIT_UID, Collections.emptySet(), EmployeeModel.class,
				createPageableData(0, 5)));
	}
	...
	{
		defaultOrgUnitService.getMembers(createOrgUnitMemberParameter(null, Collections.emptySet(), EmployeeModel.class,
				createPageableData(0, 5)));
	}
	...
	{
		defaultOrgUnitService.getMembers(createOrgUnitMemberParameter(NA_UNIT_UID, Collections.emptySet(), null,
				createPageableData(0, 5)));
	}
