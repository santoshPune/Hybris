...
public class DefaultEmailContextFactory implements EmailContextFactory<BusinessProcessModel>
{
			...
			final AbstractEmailContext<BusinessProcessModel> emailContext, final BusinessProcessModel businessProcessModel)
	{
		...
		for (final AbstractCMSComponentModel component : contentSlotModel.getCmsComponents())
		{
					...
					&& !getCmsComponentService().isComponentContainer(componentType.getCode()))
			{
				...
				{
					renderTemplate(emailContext, text, component, renderTemplateCode, renderTemplateModel, site);
				}
				else
				{
			...
			final BaseSiteModel site)
	{
		...
		logDebugInfo(emailContext, componentContext);
	...
	protected void logDebugInfo(final AbstractEmailContext<BusinessProcessModel> emailContext,
	...
	protected void appendTokensToBuffer(final AbstractEmailContext<BusinessProcessModel> emailContext,
