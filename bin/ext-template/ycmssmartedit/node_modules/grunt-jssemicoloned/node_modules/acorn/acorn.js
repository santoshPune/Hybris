...
(function(mod) {
  ...
  exports.version = "0.1.01-semicolon";
  ...
  exports.parse = function(inpt, opts) {
    ...
    setOptions(opts);
    initTokenState();
    var result = parseTopLevel(options.program);
    result.semicolonInserts = semicolonInserts;
    return result;
  };
  ...
  function canInsertSemicolon() {
    var result = !options.strictSemicolons &&
      (tokType === _eof || tokType === _braceR || newline.test(input.slice(lastEnd, tokStart)));
    if (result) {
      semicolonInserts.push(lastEnd);
    }
    return result;
  }
