...
public class YEmptyManager extends GeneratedYEmptyManager
{
	...
	private static final Logger LOG = LoggerFactory.getLogger(YEmptyManager.class);
	...
	{
		return (YEmptyManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(YEmptyConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		LOG.debug("init() of YEmptyManager called, current tenant: {}", getTenant().getTenantID());
	}
