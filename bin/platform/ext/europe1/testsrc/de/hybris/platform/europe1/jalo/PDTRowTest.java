...
public class PDTRowTest extends ServicelayerBaseTest
{
	...
	public void shouldSaveViaSLDAndReplicateProductMatchQualifierBehaviour()
	{
		...
		PersistenceUtils.<Void> doWithSLDPersistence(() -> {
			...
			final ProductPriceGroup productPriceGroup = ProductPriceGroup.valueOf(priceGroupCode);

			final DiscountRowModel discountRowWithPg = createDiscountRow(discount);
			discountRowWithPg.setPg(productPriceGroup);
			...
			final EnumerationValueModel pgModel = typeService.getEnumerationValue(productPriceGroup.getType(),
					productPriceGroup.getCode());
	...
	@Test
	public void rowCanOnlyHaveUserOrUserGroupAssignedInJalo()
