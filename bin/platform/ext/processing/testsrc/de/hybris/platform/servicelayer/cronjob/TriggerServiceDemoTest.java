...
public class TriggerServiceDemoTest extends ServicelayerBaseTest
{
			...
			final Class<? extends Item> jaloClass) throws JaloTypeException
	{
		...
		final ComposedType type = manager.createComposedType(manager.getComposedType(parentJaloClass), typeCode);
	 ...
	 */
	@Test
	public void testJobCreationWithNonWritableJobAttribute() throws JaloTypeException
	{
