...
import static de.hybris.platform.oauth2.AuthFailureListener.OAUTH2_MAX_AUTHENTICATION_ATTEMPTS;
...
public class AuthFailureListstenerIT extends ServicelayerTransactionalBaseTest
{
	...
	public void setUp() throws Exception
	{
		...
		OAuthClientDetailsModel client = model.create(OAuthClientDetailsModel.class);
	...
	public void createNewAttemptsRecord() throws Exception
	{
		listener.onApplicationEvent(
				new AuthenticationFailureBadCredentialsEvent(new UsernamePasswordAuthenticationToken(testId, PWD),
	...
	{
		return search.searchUnique(new FlexibleSearchQuery(
