...
public class XSSFilterTest
{
	...
	public void testSetup() throws Exception
	{
		...
		strippingFilter.initFromConfig(createMockFilterConfig(true, createDefaultRulePatternDefinitions(), Collections.EMPTY_MAP,
				XSSMatchAction.STRIP));

		rejectingFilter = new XSSFilter();
		rejectingFilter.initFromConfig(createMockFilterConfig(true, createDefaultRulePatternDefinitions(), Collections.EMPTY_MAP,
				XSSMatchAction.REJECT));

		headerInjectingFilter = new XSSFilter();
		headerInjectingFilter.initFromConfig(createMockFilterConfig(true, Collections.EMPTY_MAP, createSampleHeaders(),
				XSSMatchAction.REJECT));
