...
@IntegrationTest
public class BruteForceLoginFailureTest extends BruteForceLoginTest
{
	@Resource(name = "bruteForceLoginFailure")
	private BruteForceLoginFailure listener;
	...
	public void testMultiGroups() throws Exception
	{
		...
		group.setMaxBruteForceLoginAttempts(3);
