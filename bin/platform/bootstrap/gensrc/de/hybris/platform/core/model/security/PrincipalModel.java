...
public class PrincipalModel extends ItemModel
{
	...
	public String getCN()
	{
		return getPersistenceContext().getPropertyValue(CN);
	}
	...
	public String getDN()
	{
		return getPersistenceContext().getPropertyValue(DN);
	}
	 ...
	 * @return the ldapsearchbase - CAUTION: You have to copy the value of the attribute 'LDAPSEARCHBASE' to the attribute 'DN', yourself !!! 
	 * 						@deprecation You have to use {@link #getDN()} instead
	 */
	@Accessor(qualifier = "ldapsearchbase", type = Accessor.Type.GETTER)
	public String getLdapsearchbase()
	{
		return getPersistenceContext().getPropertyValue(LDAPSEARCHBASE);
	}
	...
	{
		getPersistenceContext().setPropertyValue(CN, value);
	}
	...
	{
		getPersistenceContext().setPropertyValue(DN, value);
	}
	 ...
	 *  
	 * @param value the ldapsearchbase - CAUTION: You have to copy the value of the attribute 'LDAPSEARCHBASE' to the attribute 'DN', yourself !!! 
	 * 						@deprecation You have to use {@link #getDN()} instead
	 */
	@Accessor(qualifier = "ldapsearchbase", type = Accessor.Type.SETTER)
	public void setLdapsearchbase(final String value)
	{
		getPersistenceContext().setPropertyValue(LDAPSEARCHBASE, value);
	}
