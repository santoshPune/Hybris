...
public class ComposedTypeModel extends TypeModel
{
	...
	{
		return getPersistenceContext().getPropertyValue(HMCICON);
	}
	...
	{
		return getPersistenceContext().getPropertyValue(LOGHMCCHANGES);
	}
	...
	{
		getPersistenceContext().setPropertyValue(HMCICON, value);
	}
	...
	{
		getPersistenceContext().setPropertyValue(LOGHMCCHANGES, value);
	}
