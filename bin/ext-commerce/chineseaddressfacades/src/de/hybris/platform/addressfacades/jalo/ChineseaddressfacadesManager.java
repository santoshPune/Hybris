...
/**
 * This is the extension manager of the Chineseaddressfacades extension.
 */
public class ChineseaddressfacadesManager extends GeneratedChineseaddressfacadesManager
{
	 ...
	 */
	public static ChineseaddressfacadesManager getInstance()
	{
		return (ChineseaddressfacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ChineseaddressfacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ChineseaddressfacadesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ChineseaddressfacadesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ChineseaddressfacadesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ChineseaddressfacadesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
