...
public class DefaultRuleEngineCalculationServiceCreationMethodsTest
{
	...
	{
		final BigDecimal amount = BigDecimal.valueOf(1000, 2);//10.00
		...
		assertThat(discountAmount.getAmount(), equalTo(BigDecimal.ZERO.setScale(2)));
	}
	...
	public void testCreateDiscountRAO()
	{
		...
		assertCreateDiscountRAO(new LineItemDiscount(new Money(BigDecimal.valueOf(1000, 2), currency)));
		assertCreateDiscountRAO(new LineItemDiscount(new Percentage(BigDecimal.valueOf(1000, 2))));
		assertCreateDiscountRAO(new OrderDiscount(new Money(BigDecimal.valueOf(1000, 2), currency)));
		assertCreateDiscountRAO(new OrderDiscount(new Percentage(BigDecimal.valueOf(1000, 2))));
		assertCreateDiscountRAO(new MultiLineItemDiscount(new Money(BigDecimal.valueOf(1000, 2), currency)));
	...
	{
		final BigDecimal discountAmount = BigDecimal.valueOf(100, 2);
		final BigDecimal lineItemAmount = BigDecimal.valueOf(300, 2);
	...
	{
		final BigDecimal discountAmt = BigDecimal.valueOf(100, 2);
		final BigDecimal lineItemAmt = BigDecimal.valueOf(300, 2);
		...
		assertCreateLineItemDiscountAbsolute(lineItem, discount, NOT_PER_UNIT, currency, BigDecimal.valueOf(100, 2));
	...
	public void testCreateLineItemDiscountLineItemBooleanBigDecimalPerUnitApplicableUnitsRelative()
	{
		final BigDecimal lineItemAmt = BigDecimal.valueOf(300, 2);
		final LineItem lineItem = new LineItem(new Money(lineItemAmt, currency));
		final BigDecimal discountAmt = BigDecimal.valueOf(5000, 2);
	...
	{
		final BigDecimal lineValue = BigDecimal.valueOf(1000, 2);
		final LineItem lineItem = new LineItem(new Money(lineValue, currency));
		final BigDecimal discountValue = BigDecimal.valueOf(100, 2);
	...
	public void testCreateLineItemDiscountLineItemBooleanBigDecimalBooleanAbsoluteScenerio3()
	{
		...
		service.setMinimumAmountValidationStrategy(minimumAmountValidationStrategyLowerLimitInvalid);
		final LineItemDiscount createLineItemDiscount = service.createLineItemDiscount(lineItem, ABSOLUTE, discountValue, PER_UNIT);
		assertCreateLineItemDiscountAbsolute(lineItem, createLineItemDiscount, NOT_PER_UNIT, currency, BigDecimal.ZERO.setScale(2));
	}
	...
	public void testCreateLineItemDiscountLineItemBooleanBigDecimalBooleanRelative()
	{
		...
		assertCreateLineItemDiscount(createLineItemDiscount, BigDecimal.valueOf(100, 2), PER_UNIT);

		final LineItemDiscount createLineItemDiscount2 = service.createLineItemDiscount(lineItem, RELATIVE, discountValue,
				NOT_PER_UNIT);
		assertCreateLineItemDiscount(createLineItemDiscount2, BigDecimal.valueOf(100, 2), NOT_PER_UNIT);
	...
	public void testCreateLineItemDiscountLineItemBooleanBigDecimalAbsolute()
	{
		...
		assertThat(money.getCurrency(), is(currency));
		assertThat(money.getAmount(), is(BigDecimal.valueOf(100, 2)));
		...
		assertThat(money2.getAmount(), is(BigDecimal.ZERO.setScale(2)));
	...
	public void testCreateLineItemDiscountLineItemBooleanBigDecimalRelative()
	{
		...
		assertThat(percentage.getRate(), is(BigDecimal.valueOf(100, 2)));
	...
	public void testCreateShippingCharge()
	{
		...
		final BigDecimal value = BigDecimal.valueOf(1000, 2);
