...
public class DefaultRuleMessageFormatStrategyTest
{
	...
	public void formatMessageWithDecorator()
	{
		...
		final RuleMessageParameterDecorator parameterDecorator = new RuleMessageParameterDecorator()
		{
			@Override
			public String decorate(final String formattedValue, final RuleParameterData parameter)
			{
