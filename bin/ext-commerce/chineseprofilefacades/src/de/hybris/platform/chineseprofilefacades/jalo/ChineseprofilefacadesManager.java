...
/**
 * This is the extension manager of the Chineseprofilefacades extension.
 */
public class ChineseprofilefacadesManager extends GeneratedChineseprofilefacadesManager
{
	 ...
	 */
	public static ChineseprofilefacadesManager getInstance()
	{
		return (ChineseprofilefacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(ChineseprofilefacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ChineseprofilefacadesManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ChineseprofilefacadesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ChineseprofilefacadesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ChineseprofilefacadesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
