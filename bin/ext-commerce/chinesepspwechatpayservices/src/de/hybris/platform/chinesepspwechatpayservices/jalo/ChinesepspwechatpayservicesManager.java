...
/**
 * This is the extension manager of the Chinesepspwechatpayservices extension.
 */
public class ChinesepspwechatpayservicesManager extends GeneratedChinesepspwechatpayservicesManager
{
	 ...
	 */
	public static ChinesepspwechatpayservicesManager getInstance()
	{
		return (ChinesepspwechatpayservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ChinesepspwechatpayservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ChinesepspwechatpayservicesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ChinesepspwechatpayservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ChinesepspwechatpayservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ChinesepspwechatpayservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
