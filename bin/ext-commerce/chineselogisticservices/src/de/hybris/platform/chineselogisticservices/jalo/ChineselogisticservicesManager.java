...
/**
 * This is the extension manager of the Chineselogisticservices extension.
 */
public class ChineselogisticservicesManager extends GeneratedChineselogisticservicesManager
{
	 ...
	 */
	public static ChineselogisticservicesManager getInstance()
	{
		return (ChineselogisticservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ChineselogisticservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ChineselogisticservicesManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ChineselogisticservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ChineselogisticservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ChineselogisticservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
