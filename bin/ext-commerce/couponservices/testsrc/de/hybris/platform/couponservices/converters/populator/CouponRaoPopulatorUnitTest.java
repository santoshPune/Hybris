...
public class CouponRaoPopulatorUnitTest
{
	...
	@Test
	public void testPopulateOKEmptyRaoList1()
	{
		final CartModel cartModel = new CartModel();
		cartModel.setAppliedCouponCodes(Collections.singleton(COUPON_CODE));
		when(couponService.getCouponDetails(COUPON_CODE)).thenReturn(Optional.empty());
		final CartRAO cartRao = new CartRAO();
	...
	@Test
	public void testPopulateOKEmptyRaoList2()
	{
		final CartModel cartModel = new CartModel();
