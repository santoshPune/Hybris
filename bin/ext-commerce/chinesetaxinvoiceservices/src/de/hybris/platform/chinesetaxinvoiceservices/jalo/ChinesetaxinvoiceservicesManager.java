...
/**
 * This is the extension manager of the Chinesetaxinvoiceservices extension.
 */
public class ChinesetaxinvoiceservicesManager extends GeneratedChinesetaxinvoiceservicesManager
{
	 ...
	 */
	public static ChinesetaxinvoiceservicesManager getInstance()
	{
		return (ChinesetaxinvoiceservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ChinesetaxinvoiceservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ChinesetaxinvoiceservicesManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ChinesetaxinvoiceservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ChinesetaxinvoiceservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ChinesetaxinvoiceservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
