...
/**
 * This is the extension manager of the Chinesepaymentservices extension.
 */
public class ChinesepaymentservicesManager extends GeneratedChinesepaymentservicesManager
{
	 ...
	 */
	public static ChinesepaymentservicesManager getInstance()
	{
		return (ChinesepaymentservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ChinesepaymentservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ChinesepaymentservicesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ChinesepaymentservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ChinesepaymentservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ChinesepaymentservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
