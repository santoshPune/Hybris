		...
		public int compare(final OrderEntryData arg0, final OrderEntryData arg1)
		{
			...
			if (arg0.getComponent() != null)
			{
				final BundleTemplateModel component0 = getBundleTemplateService()
						.getBundleTemplateForCode(arg0.getComponent().getId(), arg0.getComponent().getVersion());
				arg0pos = getBundleTemplateService().getPositionInParent(component0);
			}
			if (arg1.getComponent() != null)
			{
				final BundleTemplateModel component1 = getBundleTemplateService()
						.getBundleTemplateForCode(arg1.getComponent().getId(), arg1.getComponent().getVersion());
				arg1pos = getBundleTemplateService().getPositionInParent(component1);
			}
