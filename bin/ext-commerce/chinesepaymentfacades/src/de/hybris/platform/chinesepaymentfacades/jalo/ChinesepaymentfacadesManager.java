...
/**
 * This is the extension manager of the Chinesepaymentfacades extension.
 */
public class ChinesepaymentfacadesManager extends GeneratedChinesepaymentfacadesManager
{
	 ...
	 */
	public static ChinesepaymentfacadesManager getInstance()
	{
		return (ChinesepaymentfacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ChinesepaymentfacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ChinesepaymentfacadesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ChinesepaymentfacadesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ChinesepaymentfacadesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ChinesepaymentfacadesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
