...
public class DefaultIntegrationPromotionActionServiceTest extends ServicelayerTransactionalTest
{
	...
	public void testRemoveDiscountValue()
	{
		...
		discountAction.setActionStrategyKey("defaultAddOrderDiscountRAOAction");
		...
		assertEquals(
				1,
				promotionActionService.removeDiscountValue(
						promotionResultModel.getOrder().getGlobalDiscountValues().get(0).getCode(), promotionResultModel.getOrder())
						.size());
	}
