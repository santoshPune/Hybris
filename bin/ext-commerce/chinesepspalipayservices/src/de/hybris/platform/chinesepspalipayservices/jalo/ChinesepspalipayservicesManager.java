...
/**
 * This is the extension manager of the Chinesepspalipayservices extension.
 */
public class ChinesepspalipayservicesManager extends GeneratedChinesepspalipayservicesManager
{
	 ...
	 */
	public static ChinesepspalipayservicesManager getInstance()
	{
		return (ChinesepspalipayservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(ChinesepspalipayservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ChinesepspalipayservicesManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ChinesepspalipayservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ChinesepspalipayservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ChinesepspalipayservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
