...
public class SyncTaskFactoryTest
{
	...
	public void shouldRunChunkTasksForEachMediaPKPlusOneMainTaskWithConditions() throws Exception
	{
		...
		final MediasForType mediasForType1 = MediasForType.builder().withComposedTypeCode(composedType1.getCode())
				...
				.build();
		final MediasForType mediasForType2 = MediasForType.builder().withComposedTypeCode(composedType1.getCode())
