...
<body style="font-family: arial;">
	...
	<form id="mock" action="${baseGateWay}/directpay" method="POST">
		<c:forEach var="var" items="${params}">
		...
		<input id="notifyErrorBtn" type="button" name="action" value="notify_error" /> 
		<input id="returnBtn" type="submit" name="action" value="return" />
