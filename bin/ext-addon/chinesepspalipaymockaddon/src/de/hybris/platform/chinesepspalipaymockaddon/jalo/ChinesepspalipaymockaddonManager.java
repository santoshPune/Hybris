...
/**
 * This is the extension manager of the Chinesepspalipaymockaddon extension.
 */
public class ChinesepspalipaymockaddonManager extends GeneratedChinesepspalipaymockaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(ChinesepspalipaymockaddonManager.class.getName());
	 ...
	 */
	public static ChinesepspalipaymockaddonManager getInstance()
	{
		return (ChinesepspalipaymockaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ChinesepspalipaymockaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ChinesepspalipaymockaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ChinesepspalipaymockaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ChinesepspalipaymockaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ChinesepspalipaymockaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
