...
/**
 * This is the extension manager of the Chinesestoreaddon extension.
 */
public class ChinesestoreaddonManager extends GeneratedChinesestoreaddonManager
{
	 ...
	 */
	public static ChinesestoreaddonManager getInstance()
	{
		return (ChinesestoreaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(ChinesestoreaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ChinesestoreaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ChinesestoreaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ChinesestoreaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ChinesestoreaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
