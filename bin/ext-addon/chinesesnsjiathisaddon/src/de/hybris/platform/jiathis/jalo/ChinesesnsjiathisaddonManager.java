...
/**
 * This is the extension manager of the Chinesesnsjiathisaddon extension.
 */
public class ChinesesnsjiathisaddonManager extends GeneratedChinesesnsjiathisaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(ChinesesnsjiathisaddonManager.class.getName());
	 ...
	 */
	public static ChinesesnsjiathisaddonManager getInstance()
	{
		return (ChinesesnsjiathisaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ChinesesnsjiathisaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ChinesesnsjiathisaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ChinesesnsjiathisaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ChinesesnsjiathisaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ChinesesnsjiathisaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
