...
angular.module('app', ['ngMockE2E', 'coretemplates', 'modalServiceModule', 'resourceLocationsModule', 'languageServiceModule'])
    .controller('defaultController', function($scope, $httpBackend, $log, modalService, I18N_RESOURCE_URI, languageService) {
        ...
        $scope.openModalWithTitle = function() {
            modalService.open({
                ...
                templateUrl: 'smarteditcontainerJSTests/e2e/modalservice/extended/modalContentTemplate.html'
