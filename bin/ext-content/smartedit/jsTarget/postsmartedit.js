...
(function() {
    angular.module('smartedit', [
        ...
        .directive('body', ['sakExecutor', 'gatewayFactory', 'perspectiveService', 'languageService', function(sakExecutor, gatewayFactory, perspectiveService, languageService) {
            return {
                restrict: "E",
                replace: false,
                transclude: false,
         ...
         */
        .run(['domain', 'systemEventService', 'restServiceFactory', 'gatewayFactory', 'renderService', 'renderGateway', 'decoratorService', 'featureService', 'slotFixService', function(domain, systemEventService, restServiceFactory, gatewayFactory, renderService, renderGateway, decoratorService, featureService, slotFixService) {
