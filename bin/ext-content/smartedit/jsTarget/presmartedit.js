...
.factory('systemPerspectives', ['Perspective', function(Perspective) {
...
.factory('decoratorFilterService', ['decoratorService', 'perspectiveStorage', 'Perspective', function(decoratorService, perspectiveStorage, Perspective) {
...
.factory('dragAndDropService', ['DragAndDropServiceInterface', 'gatewayProxy', '$compile', '$rootScope', 'hitch', 'extend', function(DragAndDropServiceInterface, gatewayProxy, $compile, $rootScope, hitch, extend) {
...
(function() {
    ...
    angular.module('slotFixServiceModule', ['componentHandlerServiceModule'])
        .factory('slotFixService', ['componentHandlerService', 'COMPONENT_CLASS', 'TYPE_ATTRIBUTE', function(componentHandlerService, COMPONENT_CLASS, TYPE_ATTRIBUTE) {
            // Constants
