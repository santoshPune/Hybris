...
angular.module('authenticationModule', ['authenticationInterfaceModule', 'gatewayProxyModule', 'functionsModule', 'languageSelectorModule', 'resourceLocationsModule', 'storageServiceModule', 'sharedDataServiceModule', 'alertServiceModule', 'modalServiceModule', 'ui.bootstrap', 'eventServiceModule'])
     ...
     */
    .factory('authenticationService', function($rootScope, $q, $injector, $log, AuthenticationServiceInterface, LANDING_PAGE_PATH, MODAL_BUTTON_ACTIONS, DEFAULT_AUTHENTICATION_ENTRY_POINT, DEFAULT_AUTH_MAP, DEFAULT_CREDENTIALS_MAP, gatewayProxy, sharedDataService, storageService, alertService, systemEventService, EVENTS, getQueryString, convertToArray, hitch, copy, merge, isBlank, extend) {
