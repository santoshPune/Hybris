...
/**
 * This is the extension manager of the Npmancillary extension.
 */
public class NpmancillaryManager extends GeneratedNpmancillaryManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(NpmancillaryManager.class.getName());
	 ...
	 */
	public static NpmancillaryManager getInstance()
	{
		return (NpmancillaryManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				NpmancillaryConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public NpmancillaryManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of NpmancillaryManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of NpmancillaryManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of NpmancillaryManager called, current tenant: " + getTenant().getTenantID());
		}
	}
