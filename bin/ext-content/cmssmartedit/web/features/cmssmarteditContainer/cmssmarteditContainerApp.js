...
angular.module('cmssmarteditContainer', [
    ...
    .config(function(PAGE_LIST_PATH, $routeProvider) {
    ...
    .run(
        function($log, $rootScope, ComponentService, systemEventService, cmsDragAndDropService, catalogDetailsService, featureService, perspectiveService, assetsService) {
