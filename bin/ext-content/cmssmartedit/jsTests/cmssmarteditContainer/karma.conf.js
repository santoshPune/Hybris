...
module.exports = function(config) {
    config.set({
        ...
        files: [
            ...
            'bower_components/polyfills/bindPolyfill.js',
            'buildArtifacts/seLibraries/smartEditContainer/services/resourceLocations.js',
            'buildArtifacts/seLibraries/smartEditContainer/**/*.js',
            'buildArtifacts/seLibraries/smartEdit/**/*.js',
            'buildArtifacts/seLibraries/smartEditContainer/services/i18nInterceptor.js',
            'buildArtifacts/static-resources/thirdparties/angular-sanitize/angular-sanitize.min.js',
            'jsTests/utils/**/*.js',
            'jsTests/cmssmarteditContainer/unit/**/*Setup.js',
            'web/**/*.html',
            ...
            'web/features/cmssmarteditContainer/**/*.js',
            'jsTests/cmssmarteditContainer/unit/features/**/*Test.js',
