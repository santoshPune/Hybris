...
module.exports = function(config) {
    config.set({
        ...
        files: [
            ...
            'bower_components/polyfills/endsWithPolyfill.js',
            'bower_components/polyfills/findPolyfill.js',
            'bower_components/polyfills/uint8ArrayReducePolyfill.js',
            'buildArtifacts/seLibraries/smartEdit/services/resourceLocations.js',
            'buildArtifacts/seLibraries/smartEdit/services/functions.js',
            'jsTests/utils/**/*.js',
            'jsTests/cmssmartedit/unit/**/*Setup.js',
            'web/**/*.html',
