...
import de.hybris.platform.smarteditwebservices.validation.facade.impl.DefaultFacadeValidationService;
...
public class DefaultSmarteditConfigurationFacadeTest
{
	...
	@InjectMocks
	private DefaultSmarteditConfigurationFacade configurationFacade = new DefaultSmarteditConfigurationFacade();

	@Before
	public void setup() throws InvocationTargetException, IllegalAccessException
	{

		when(configurationService.findAll()).thenReturn(Arrays.asList(CONFIGURATION_MODEL_1, CONFIGURATION_MODEL_2,
	...
	{
		ConfigurationData data1 = buildConfiguraitonData(CONFIGURATION_MODEL_1);
		ConfigurationData data2 = buildConfiguraitonData(CONFIGURATION_MODEL_2);
		ConfigurationData data3 = buildConfiguraitonData(CONFIGURATION_MODEL_3);
	...
	private ConfigurationData buildConfiguraitonData(final SmarteditConfigurationModel configurationModel)
	{
	...
	public void testUpdate() throws InvocationTargetException, IllegalAccessException
	{
		...
		final ConfigurationData configurationDataCreated = configurationFacade.update(configurationData.getKey(), configurationData);
	...
	public void findByDefaultConfigurationKey_will_return_configuration_data() throws Exception {
		...
		ConfigurationData config = configurationFacade.findByDefaultConfigurationKey(DEFAULT_LANGUAGE);
