...
module.exports = function(config) {
    config.set({
        ...
        coverageReporter: {
            ...
            dir: 'jsTarget/test/commons/coverage/',
            reporters: [{
                type: 'html',
                subdir: 'report-html'
            }, {
        ...
        junitReporter: {
            outputDir: 'jsTarget/test/commons/junit/', // results will be saved as $outputDir/$browserName.xml
        ...
        files: [
            ...
            'web/features/**/*.js',
            'jsTarget/web/features/**/templates.js',
            'jsTests/unit/testsModule.js',
            'jsTests/unit/mockModules.js',
            'jsTests/unit/commons/*Test.js'
        ],
