...
import de.hybris.constants.NpmtestancillaryConstants;



/**
 * This is the extension manager of the Npmtestancillary extension.
 */
public class NpmtestancillaryManager extends GeneratedNpmtestancillaryManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(NpmtestancillaryManager.class.getName());
	 ...
	 */
	public static NpmtestancillaryManager getInstance()
	{
		return (NpmtestancillaryManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				NpmtestancillaryConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public NpmtestancillaryManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of NpmtestancillaryManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of NpmtestancillaryManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of NpmtestancillaryManager called, current tenant: " + getTenant().getTenantID());
		}
	}
