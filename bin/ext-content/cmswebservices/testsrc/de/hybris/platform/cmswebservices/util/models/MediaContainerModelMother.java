...
import de.hybris.platform.cmswebservices.util.builder.MediaContainerModelBuilder;
...
public class MediaContainerModelMother extends AbstractModelMother<MediaContainerModel>
{
	...
	private MediaContainerModel createMediaContainerModelWithQualifier(final CatalogVersionModel catalogVersion, final String qualifier,
			final List<MediaModel> mediaList)
	{
		return getFromCollectionOrSaveAndReturn(
				() -> getMediaContainerDao().findMediaContainersByQualifier(qualifier), () -> {
