...
public class SimpleBannerComponentValidatorTest
{
	...
	private void reject(final String fieldName, final String errorCode, final String language, final Errors errors)
	{
		errors.rejectValue(fieldName, errorCode, new Object[]
				{ language }, null);
	}

	private SimpleBannerComponentData createEmptySimpleBannerComponent()
	{
	...
	private SimpleBannerComponentData createSimpleBannerComponentWithInvalidMediaCodes()
	{
		final SimpleBannerComponentData data = new SimpleBannerComponentData();
		final Map<String, String> localizedMediaCodes = new HashMap<>();
	...
	private SimpleBannerComponentData createSimpleBannerComponent()
	{
		final SimpleBannerComponentData data = new SimpleBannerComponentData();
