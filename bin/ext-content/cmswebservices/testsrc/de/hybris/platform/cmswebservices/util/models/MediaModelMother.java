...
public class MediaModelMother extends AbstractModelMother<MediaModel>
{
	...
	private MediaModel createMediaModelWithCode(final CatalogVersionModel catalogVersion, final MediaTemplate template,
			final String code)
	{
	...
	private MediaModel createMediaModelWithFormat(final CatalogVersionModel catalogVersion, final MediaTemplate template,
