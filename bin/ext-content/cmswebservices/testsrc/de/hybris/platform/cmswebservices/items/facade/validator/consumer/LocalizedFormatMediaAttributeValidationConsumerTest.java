...
public class LocalizedFormatMediaAttributeValidationConsumerTest
{
	...
	public void setup()
	{
		...
		optionalValidationData.put(CmswebservicesConstants.MEDIA_FORMAT, MEDIA_FORMAT_MOBILE);
	}
	...
	public void testValidNonLocalizedMedia()
	{
		...
		final LocalizedValidationData errorContainer = new LocalizedValidationData.Builder()
		.setFieldName(MEDIA_FIELD_NAME)
		.setValue(mediaCode)
		.setRequiredLanguage(false)
		.setLocale(null)
		.setOptionals(optionalValidationData)
		.build();
	...
	public void testInvalidLocalizedMediaExceptionThrown()
	{
		...
		when(mediaService.getMedia(catalogVersion, mediaCode)).thenThrow(
