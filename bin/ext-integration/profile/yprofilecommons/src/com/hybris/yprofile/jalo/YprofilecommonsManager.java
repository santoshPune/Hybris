...
import com.hybris.yprofile.constants.YprofilecommonsConstants;



/**
 * This is the extension manager of the Yprofilecommons extension.
 */
public class YprofilecommonsManager extends GeneratedYprofilecommonsManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(YprofilecommonsManager.class.getName());
	 ...
	 */
	public static YprofilecommonsManager getInstance()
	{
		return (YprofilecommonsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				YprofilecommonsConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public YprofilecommonsManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of YprofilecommonsManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of YprofilecommonsManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of YprofilecommonsManager called, current tenant: " + getTenant().getTenantID());
		}
	}
