...
public class ErrorResolver
{
	...
	protected static List<FieldError> removeDuplicateFieldErrors(final List<FieldError> containsDuplicates)
	{
	...
	protected static List<FieldError> getFieldErrors(final List<FieldError> errorList, final Predicate<FieldError> filter)
	{
	...
	protected static boolean isConfigErrorInConflictHeader(final FieldError error)
	{
		return isConfigError(error) && (error.getField().startsWith(CONFLICT_HEADER_GROUP_PATH));
	}

	protected static boolean isCorrectGroup(final String path, final FieldError objError)
	{
