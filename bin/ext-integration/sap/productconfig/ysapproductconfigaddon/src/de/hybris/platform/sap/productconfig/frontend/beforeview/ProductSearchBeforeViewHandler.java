 ...
 *
 */
public class ProductSearchBeforeViewHandler implements BeforeViewHandlerAdaptee
{

	public static final String PRODUCT_CONFIG_PRODUCT_LISTER_FRAGMENT_VIEW_NAME = "addon:/"
			+ SapproductconfigaddonConstants.EXTENSIONNAME + "/fragments/product/productLister";
	public static final String PRODUCT_LISTER_FRAGMENT_VIEW_NAME = "fragments/product/productLister";
	private static final Logger LOG = Logger.getLogger(ProductSearchBeforeViewHandler.class);
			...
			final String viewName)
	{
		...
		String beforViewName = viewName;
		if (PRODUCT_LISTER_FRAGMENT_VIEW_NAME.equals(viewName))
		{
			beforViewName = PRODUCT_CONFIG_PRODUCT_LISTER_FRAGMENT_VIEW_NAME;
		}

		return beforViewName;
	}
