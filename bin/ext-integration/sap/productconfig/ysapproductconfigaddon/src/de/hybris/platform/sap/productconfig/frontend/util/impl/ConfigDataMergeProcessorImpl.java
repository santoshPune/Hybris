 ...
 * <br>
 * The bean must have prototype scope as we use class members to process the path to the group which is currently
...
public class ConfigDataMergeProcessorImpl implements ConfigDataMergeProcessor
{
	...
	/**
	 * @param tokenizerGroupId
	 *           the tokenizerGroupId to set
	 */
	public void setTokenizerGroupId(final StringTokenizer tokenizerGroupId)
	{
	...
	/**
	 * @param tokenizerPath
	 *           the tokenizerPath to set
	 */
	public void setTokenizerPath(final StringTokenizer tokenizerPath)
	{
