...
/**
 * This is the extension manager of the Sapproductconfigb2bservices extension.
 */
public class Sapproductconfigb2bservicesManager extends GeneratedSapproductconfigb2bservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Sapproductconfigb2bservicesManager.class.getName());
	 ...
	 */
	public static Sapproductconfigb2bservicesManager getInstance()
	{
		return (Sapproductconfigb2bservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Sapproductconfigb2bservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Sapproductconfigb2bservicesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Sapproductconfigb2bservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Sapproductconfigb2bservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Sapproductconfigb2bservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
