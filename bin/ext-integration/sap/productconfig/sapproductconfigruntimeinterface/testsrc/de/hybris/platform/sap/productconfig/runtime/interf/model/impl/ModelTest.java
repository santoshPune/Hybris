...
public class ModelTest
{
	...
	private static final String SKIP_CSTIC_FIELDS = "assignedValuesUnmodifiable|assignableValuesUnmodifiable|conflicts|changedByFrontend|allowsAdditionalValues|intervalInDomain|entryFieldMask|author|placeholder|instanceId|retractTriggered|assumptionId";
	private static final String SKIP_CSTIC_VALUE_FIELDS = "domainValue|languageDependentName|selectable|author|authorExternal|deltaPrice|valuePrice";
	private static final String IGNORE_ALWAYS_FIELD = "$jacocoData";
	private static final String SKIP_CONFLICTS = "solvableConflicts";
