...
public class DataLoaderJob extends AbstractJobPerformable<DataLoaderCronJobModel>
{
	...
	protected DataloaderManager prepareDataloadManager(final DataLoaderCronJobModel dataLoaderCronJobModel)
	{
		...
		final DataloaderSourceParameters params = dataLoaderConfigurationHelper.getDataloaderSourceParam(sapConfiguration);

		final Map<String, String> dataloaderConfigMap = dataLoaderConfigurationHelper.createConfigMap(params);

		// Filter files
		dataLoaderConfigurationHelper.prepareFilterFiles(dataloaderConfigMap, sapConfiguration);
		...
		final DataloaderManager dataloaderManager = new DataloaderManagerImpl(dataloaderConfiguration, dataloaderWorker);
