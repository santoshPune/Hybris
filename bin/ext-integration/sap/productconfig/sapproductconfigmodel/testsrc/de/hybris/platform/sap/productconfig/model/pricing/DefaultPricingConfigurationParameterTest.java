...
public class DefaultPricingConfigurationParameterTest
{
	...
	public void setUp() throws Exception
	{
		...
		pricingParameter = new DefaultPricingConfigurationParameter();
	...
	{
		when(moduleConfigurationAccess.getProperty(SapproductconfigmodelConstants.CONFIGURATION_PRICING_PROCEDURE))
	...
	{
		when(moduleConfigurationAccess.getProperty(SapproductconfigmodelConstants.CONFIGURATION_CONDITION_FUNCTION_BASE_PRICE))
