...
public class ConfigurationTestData
{
	...
	public final static String RB_NAME_FLOAT = "SAP_RADIOBUTTON_SIMPLE_FLOAT";
	public final static String RB_LD_NAME_FLOAT = "Float RadioButton:";
	...
	public static void setPrice(final CsticValueModel value, final String price)
	{
		...
		if (price == null)
		{
			value.setDeltaPrice(PriceModel.NO_PRICE);
		}
		else
		{
