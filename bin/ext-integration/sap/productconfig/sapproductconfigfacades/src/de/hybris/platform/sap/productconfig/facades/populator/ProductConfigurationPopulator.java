...
public class ProductConfigurationPopulator<SOURCE extends ProductModel, TARGET extends ProductData>
		extends AbstractProductPopulator<SOURCE, TARGET>
{
	...
	public void populate(final SOURCE productModel, final TARGET productData) throws ConversionException
	{
		...
		if (LOG.isDebugEnabled())
		{
			...
			LOG.debug("Populating for " + productModel.getName() + " (" + productModel.getCode() + "): configurable="
					+ isProductConfigurable + " took " + duration + " ms");
		}
	}
