...
public class SapOrdermgmtB2BCartFacadeTest
{
	...
	public void setUp()
	{
		...
		sapOrdermgmtB2BCartFacade.setProductConfigurationService(productConfigurationService);
		sapOrdermgmtB2BCartFacade.setConfigurationProviderFactory(configurationProviderFactory);
	...
	public void testCheckForConfigurationRelease()
	{
		...
		sapOrdermgmtB2BCartFacade.checkForConfigurationRelease(1, ITTEM_KEY);

		given(configurationProviderFactory.getProvider()).willReturn(Mockito.mock(ConfigurationProvider.class));
		sapOrdermgmtB2BCartFacade.checkForConfigurationRelease(0, ITTEM_KEY);

	}

	/**
	 * Test method for
	 * {@link de.hybris.platform.sap.sapordermgmtb2bfacades.cart.impl.SapOrdermgmtB2BCartFacade#getItemKey(long)}.
	 */
	@Test
	public void testGetItemKey()
	{

		assertEquals(ITTEM_KEY, sapOrdermgmtB2BCartFacade.getItemKey(ENTRY_NUMBER));
	}
