 ...
 */
package de.hybris.platform.recentvieweditemsservices.jalo;

import de.hybris.platform.core.Registry;
import de.hybris.platform.recentvieweditemsservices.constants.RecentViewedItemsServicesConstants;
...
/**
 * This is the extension manager of the recentvieweditemsservices extension.
 */
public class RecentViewedItemsServicesManager extends GeneratedRecentViewedItemsServicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(RecentViewedItemsServicesManager.class.getName());
	 ...
	 */
	public static RecentViewedItemsServicesManager getInstance()
	{
		return (RecentViewedItemsServicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(RecentViewedItemsServicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public RecentViewedItemsServicesManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of RecentViewedItemsServicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of RecentViewedItemsServicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of RecentViewedItemsServicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
