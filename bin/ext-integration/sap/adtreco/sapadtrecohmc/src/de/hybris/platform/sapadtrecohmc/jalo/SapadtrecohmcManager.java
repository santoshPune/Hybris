 ...
 */
package de.hybris.platform.sapadtrecohmc.jalo;

import de.hybris.platform.core.Registry;
import de.hybris.platform.sapadtrecohmc.constants.SapadtrecohmcConstants;
...
/**
 * This is the extension manager of the Sapadtrecohmc extension.
 */
public class SapadtrecohmcManager extends GeneratedSapadtrecohmcManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapadtrecohmcManager.class.getName());
	 ...
	 */
	public static SapadtrecohmcManager getInstance()
	{
		return (SapadtrecohmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapadtrecohmcConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapadtrecohmcManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapadtrecohmcManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapadtrecohmcManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapadtrecohmcManager called, current tenant: " + getTenant().getTenantID());
		}
	}
