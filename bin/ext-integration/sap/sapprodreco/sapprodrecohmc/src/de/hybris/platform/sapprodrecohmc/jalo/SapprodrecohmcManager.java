 ...
 */
package de.hybris.platform.sapprodrecohmc.jalo;
...
import de.hybris.platform.sapprodrecohmc.constants.SapprodrecohmcConstants;



/**
 * This is the extension manager of the Sapprodrecohmc extension.
 */
public class SapprodrecohmcManager extends GeneratedSapprodrecohmcManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapprodrecohmcManager.class.getName());
	 ...
	 */
	public static SapprodrecohmcManager getInstance()
	{
		return (SapprodrecohmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapprodrecohmcConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapprodrecohmcManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapprodrecohmcManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapprodrecohmcManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapprodrecohmcManager called, current tenant: " + getTenant().getTenantID());
		}
	}
