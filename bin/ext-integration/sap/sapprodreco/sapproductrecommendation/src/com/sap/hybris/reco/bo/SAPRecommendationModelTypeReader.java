...
public class SAPRecommendationModelTypeReader
{
	...
	private static final String ORDER_BY = MODEL_TYPE_ID;
	protected RecommendationEntityManager accessBE;



	/**
	 * Gets all Recommendation Model Types
	 *
	 ...
	 * @throws IOException
	 */
	public List<SAPRecommendationType> getAllRecommendationModelTypes() throws ODataException, URISyntaxException, IOException
	{
	...
	/**
	 * extracts the Recommendation Model Types
	 */
	...
	/**
	 * extracts a Recommendation Model Type
	 */
