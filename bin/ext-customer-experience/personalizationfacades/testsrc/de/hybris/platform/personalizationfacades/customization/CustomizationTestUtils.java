...
public class CustomizationTestUtils
{
	...
	public static CustomizationData creteCustomizationData(final String customizationCode, final String customizationName, final String variationCode, final String variationName,
			final Supplier<TriggerData> triggerSupplier)
	{
		...
		{
			customizationData.setVariations(Collections.singletonList(createVariationData(variationCode, variationName, triggerSupplier)));
		}

		return customizationData;
	}

	public static VariationData createVariationData(final String variationCode,final String variationName, final Supplier<TriggerData> triggerSupplier)
	{
		if (variationCode == null)
		{
			return null;
	...
	{
		final FlexibleSearchQuery fQuery = new FlexibleSearchQuery("SELECT {" + CxCustomizationModel.PK + "} FROM {"
				+ CxCustomizationModel._TYPECODE + "} ");
